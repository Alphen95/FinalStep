...
class Window:
    def __init__(self, screen, window_size_y=300, title="", x=50, y=50, objects=[("label", "", 0, 0, 100, 40, "")], size_x=300, size_y=150, hidable=False, has_titlebar=True, closable=True, functions=[("", "")], on_refresh=()):
        self.title = title
        self.x = x
        self.y = y
        self.size_x = size_x
